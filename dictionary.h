...
class Dictionary {
 protected:
  ...
  std::vector<int32_t> misword2int_;
  std::vector<entry> mis_words_;
  std::vector<int32_t> corword2int_;
  std::vector<entry> cor_words_;
 ...
 public:
  ...
  const std::vector<std::string>& getSubstrings(int32_t) const;
  const std::vector<int32_t>& getExcludedSubwords(int32_t i) const;
  const std::vector<int32_t> getSubwords(const std::string&) const;
  const std::vector<std::string> getSubstrings(const std::string&) const;
  void getSubwords(
      const std::string&,
      std::vector<int32_t>&,
  ...
  void add_mis(const std::string&);
  void add_cor(const std::string&);
  bool readWord(std::istream&, std::string&) const;
  bool readP(std::istream&, std::string&) const;
  //bool readPair(std::istream& in, std::string& mw, std::string& me) const;
  int32_t readFromFile(std::istream&);
  int32_t readFromM(std::istream&);
  ...
  int32_t getLine(std::istream&, std::vector<int32_t>&, std::minstd_rand&)
      const;
  int32_t countLine(std::istream& in) const;
  int32_t getPairs(
          std::istream& in,
  ...
  int32_t getAugmented(std::istream& in,
                       std::istream& in_moe,
