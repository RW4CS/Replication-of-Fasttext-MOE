...
class FastText {
 ...
 protected:
  ...
  std::shared_ptr<Dictionary> dict_moe;
  std::shared_ptr<Matrix> input_;
  std::shared_ptr<Matrix> input_word_;
  ...
  std::shared_ptr<Matrix> createRandomWordMatrix() const;
  ...
  void skipgram(Model::State& state,
          real lr,
          const std::vector<int32_t>& line,
          real alpha,
          real ratio,
  ...
  void skipgram_moe(Model::State& state, real lr, const std::vector<int32_t>& line, real alpha);
 ...
 public:
  ...
  void save2Vectors(const std::string& filename1, const std::string& filename2);
